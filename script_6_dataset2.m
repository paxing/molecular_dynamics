...
data=csvread("PHS6953HE_lab1_Dataset2.csv", 1,0);
...
text(0.25, 0.25, caption, 'FontSize', 16, 'Color', 'k', 'Interpreter','latex');
%print(gcf,'6a','-dpng','-r300');
